    ...
    <div className="mt-16 px-4">
      ...
      <div className="mt-8">
        ...
        <form className="flex flex-col mt-8">
          ...
          <button className="mt-6 bg-orange-500 hover:bg-orange-600 text-white py-2 border border-transparent rounded-md shadow-md text-sm font-medium focus:ring-2 focus:ring-offset-2 focus:ring-orange-500 focus:outline-none">
        ...
        <div className="mt-8">
          ...
          <div className="grid grid-cols-2 gap-3 mt-3">
            <button className="flex justify-center items-center py-2 px-4 border border-gray-300 rounded-md shadow-sm font-medium text-blue-400 hover:bg-gray-50">
              <svg
                className="w-5 h-5"
                aria-hidden="true"
                fill="currentColor"
            ...
            <button className="flex justify-center items-center py-2 px-4 border border-gray-300 rounded-md shadow-sm font-medium hover:bg-gray-50">
              <svg
                className="w-5 h-5"
                aria-hidden="true"
                fill="currentColor"
